...
const Customization = () => {
    ...
    const [outlinedFilled, setOutlinedFilled] = React.useState<boolean>(customization.outlinedFilled);
    const handleOutlinedFilled = (event: React.ChangeEvent<HTMLInputElement>) => {
