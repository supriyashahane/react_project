...
const Profile3 = Loadable(lazy(() => import('views/sample-page/Profile3')));
const Profile4 = Loadable(lazy(() => import('views/sample-page/Expired/Profile3')));
const Layouts = Loadable(lazy(() => import('views/sample-page/layouts/MultiColumnForms')));
const ExpiredProjects = Loadable(lazy(() => import('views/sample-page/Expired')));
// ==============================|| MAIN ROUTING ||============================== //
