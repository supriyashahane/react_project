                ...
                <SubCard title="Primary Color">
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.light" data={{ label: 'Blue-50', color: '#f5f5f5' }} title="primary.light" dark />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                    ...
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-50', color: '#24323e42' }}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-600', color: '#24323e' }}
