                                ...
                                <Grid container alignItems="center" justifyContent="space-between" spacing={2}>
                                    ...
                                    <Grid item>
                                        <Grid item>
                                            ...
                                            <Button
                                                variant="contained"
                                                style={{ background: theme.palette.error.main, borderColor: '#24323e42' }}
                                            >
                                                Delete
                                            </Button>
                                        </Grid>
                                ...
                                <Grid container alignItems="center" justifyContent="space-between" spacing={2}>
                                    ...
                                    <Grid item>
                                        <Grid container alignItems="center" justifyContent="flex-end" spacing={2}>
                                             ...
                                             * wrong prop color="error"
                                             * color?: "inherit" | "primary" | "secondary" | undefined
                                             * placeholder style={{color: 'red', borderColor: '#24323e42'}}
                                             */}
                                            <Grid item>
                                                <Button variant="outlined" style={{ color: 'red', borderColor: '#24323e42' }}>
                                                    Delete
                                                </Button>
                                            </Grid>
                                        </Grid>
